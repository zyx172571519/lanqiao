...
public class productDaoImpl {
	...
	public List<shopCar> queryByUid(String uId) {
		String sql="select * from  product left join order_detail on order_detail.DETAIL_PRODUCT_ID=product.PRODUCT_ID left join user on order_detail.DETAIL_USER_ID=user.USER_ID where  DETAIL_ORDER_ID is NULL AND USER_ID=? ORDER BY order_detail.DETAIL_PRODUCT_ID";
